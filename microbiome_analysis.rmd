...
# Fungal alpha diversity plot

fun_alpha_plot <- plot_alpha(
  FUN$countData, FUN$colData,
  design = "experiment", colour = "weeks", shape = "year",
...
ggsave(filename = "fungal_alpha_diversity.png", plot = fun_alpha_plot, path = FIGURES_DIR)

fun_alpha_plot

# Bacterial alpha diversity plot

bac_alpha_plot <- plot_alpha(
  BAC$countData, BAC$colData,
  design = "experiment", colour = "weeks", shape = "year",
  measures = c("Shannon", "Simpson"),
  type = "box"
) + scale_colour_manual(values = cbPalette) + 
...
ggsave(filename = "bacterial_alpha_diversity.png", plot = bac_alpha_plot, path = FIGURES_DIR)
