...
# exp_da <- split(
#   apply_to_subsets(EXP, diffAbundanceOverall, "experiment") |> combine_tables(),
#   f = ~ kingdom
# )

# time_da <- split(
#   apply_to_subsets(TIME, diffAbundanceOverall, "timepoint") |> combine_tables(),
#   f = ~ kingdom
# )
...
```{r}
exp_da$FUN |> combine_tables() |> printTable()
```

#### EXP: BAC

```{r}
exp_da$BAC |> combine_tables() |> printTable()
```
