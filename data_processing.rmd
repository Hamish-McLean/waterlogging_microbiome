...
# FUN_exp  <- apply_to_subsets(FUN_exp, create_dds)
# FUN_time <- apply_to_subsets(FUN_time, create_dds)

# BAC_exp  <- apply_to_subsets(BAC_exp, create_dds)
# BAC_time <- apply_to_subsets(BAC_time, create_dds)
